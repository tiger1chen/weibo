...
<head>
	...
	<title>微博用户列表</title>
	<link rel="stylesheet" href="/go/apublic/Css/common.css" />
	<script type="text/javascript" src='/go/apublic/Js/jquery-1.8.2.min.js'></script>
	<script type="text/javascript" src='/go/apublic/Js/common.js'></script>
</head>
<body>
	<div class='status'>
		<span>微博用户检索</span>
	...
	<div style='width:600px;text-align:center;margin : 20px auto;'>
		<form action="/go/admin.php/Home/User/sechUser.html" method='get'>
			检索方式：
			<select name="type">
		...
		<?php else: ?>
			...
			<?php if(is_array($user)): foreach($user as $key=>$v): ?><tr>
					...
					<td width='80' align='center'>
						<img src="<?php if($v["face"]): ?>/go/<?php echo ($v["face"]); else: ?>/go/Public/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
					</td>
					<td align='center'>
						<ul>
