...
<head>
    ...
    <?php $style = M('userinfo')->where(array('uid'=>session('uid')))->getField('style'); ?>
    	<title>php微博-修改个人资料</title>
	<link rel="stylesheet" href="/go/Public/Theme/<?php echo ($style); ?>/Css/nav.css" />
	<link rel="stylesheet" href="/go/Public/Theme/<?php echo ($style); ?>/Css/edit.css" />
	...
	<script src="/go/Public/Js/jquery-validate.js"></script>
	<script type="text/javascript" src='/go/Public/Js/nav.js'></script>
    <script type='text/javascript' src='/go/Public/Js/city.js'></script>
    <script type='text/javascript'>
		var constellation = "<?php echo ($userinfo["constellation"]); ?>";
		var address = "<?php echo ($userinfo["location"]); ?>";
		var PUBLIC = "/go/Public";
		var uploadUrl = "<?php echo U('UserSetting/uploadFace');?>";
		var sid = "<?php echo session_id();?>";
		var ROOT = '/go';
    </script>
	<script type='text/javascript' src='/go/Public/Uploadify/jquery.uploadify.min.js'></script>
	<script type='text/javascript' src='/go/Public/Js/edit.js'></script>


<!--==========顶部固定导行条==========-->
    <script type='text/javascript'>
    var delFollow = "/weibo/index.php/UserSetting/delFollow";
    var editStyle = "/weibo/index.php/UserSetting/editStyle";
    var getMsgUrl = "/weibo/index.php/UserSetting/getMsg";
</script>
<script type="text/javascript">
...
<!--==========内容主体==========-->
 ...
 $groupName = M('group')->where(array('uid'=>session('uid')))->select(); ?>				
    ...
    <!--==========创建分组==========-->
    <script type='text/javascript'>
        var addGroup = "/weibo/index.php/UserSetting/addGroup";
    </script>
    <div id='add-group'>
        <div class="group_head">
            <span class='group_text fleft'>创建好友分组</span>
    	...
    	<div id='right'>
    		...
    		<div class='form'>
    			<form action="<?php echo U('UserSetting/editBasic');?>" method='post'>
    				<p>
    					...
    					<input type="text" name='nickname' value='<?php echo ($userinfo['username']); ?>' class='input'/>
    				</p>
    				<p>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('UserSetting/editFace');?>" method='post'>
	    			<div class='edit-face'>
	    				<img src="
    						<?php if($userinfo["face180"] != ''): ?>/go/<?php echo ($userinfo['face180']); ?>
    						<?php else: ?>
    							/go/Public/Images/noface.gif<?php endif; ?>
    						" width='180' height='180' id='face-img'/>
	    				<p>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('UserSetting/editPwd');?>" method='post' name='editPwd'>
...
<!--==========底部==========-->
    <div id="bottom">
        <div id="copy">
            <div>
                <p>
                    版权所有：php网 京ICP备10027771号-1 站长统计 All rights reserved, houdunwang.com services for Beijing 2008-2012 
                </p>
            </div>
        </div>
    </div>
...
<!--[if IE 6]>
    <script type="text/javascript" src="/go/Public/Js/DD_belatedPNG_0.0.8a-min.js"></script>
    <script type="text/javascript">
