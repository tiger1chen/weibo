...
<head>
    <meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />
    	<title>php微博-微博找人</title>
	<link rel="stylesheet" href="/go/Public/Css/nav.css" />
	<link rel="stylesheet" href="/go/Public/Css/sech_user.css" />
    ...
    <!--==========创建分组==========-->
        ...
        <div id='right'>
    		...
    		<div id='sech'>
    			...
    			<ul>
                    <li><span class='cur sech-type' url="<?php echo U('Search/searchUser');?>">找人</span></li>
    				<li><span class='sech-type' url="<?php echo U('Search/searchWeibo');?>">微博</span></li>
    			</ul>
    		</div>
    		<div id='content'>
    			<div class='view_line'>
	                <strong>用户</strong> 总共搜索到<?php echo ($count?$count:0); ?>条结果
	            </div>
	            <?php if($info): if(is_array($info)): foreach($info as $key=>$u): ?><ul>
	            	<li>
						<dl class='list-left'>
							<dt>
								<img src="<?php if($u["face80"] != ''): ?>/go/<?php echo ($u['face80']); ?>
										 <?php else: ?>
											/go/Public/Images/noface.gif<?php endif; ?>																	
								 " width='80' height='80'/>
							</dt>
							<dd>
			<a href=""><?php echo (str_replace($keyword,'<font style="color:red;">'.$keyword.'</font>',$u["username"])); ?></a>
							</dd>
							<dd>
								<i class='icon icon-boy'></i>&nbsp;
								<span><?php if($u["location"] != ''): echo ($u["location"]); ?>
										<?php else: ?>	
																			该用户未填写所在地<?php endif; ?>
										</span>
							</dd>
							<dd>
								<span>关注 <a href=""><?php echo ($u["follow"]); ?></a></span>
								<span class='bd-l'>粉丝 <a href=""><?php echo ($u["fans"]); ?></a></span>
								<span class='bd-l'>微博 <a href=""><?php echo ($u["weibo"]); ?></a></span>
							</dd>
						</dl>
	    				<dl class='list-right'>
	    						    						
	    						    						<?php if($u["mutual"] == 2 ): ?><dt>互相关注</dt>
	    						    							<dd uid="<?php echo ($u['uid']); ?>" type="1" class="del-follow" >移除</dd>
	    						    						<?php elseif($u["mutual"] == 0): ?>
																<dt class="add-fl" uid="<?php echo ($u["uid"]); ?>">+&nbsp;关注</dt>
	    						    						<?php else: ?>
	    						    							<dt>√&nbsp;已关注</dt>
	    						    							<dd uid="<?php echo ($u['uid']); ?>" type="1" class="del-follow" >移除</dd><?php endif; ?>
	    						    						   				
	    			   </dl>
	    			</li><?php endforeach; endif; ?>
	    		<?php else: ?>
	    				未找到与<strong style="color:red;"><?php echo ($keyword); ?></strong>有关的用户<?php endif; ?>   			
	    		</ul>
